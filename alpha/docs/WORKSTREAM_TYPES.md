...
The Alpha does not yet record or enforce a type in its tooling. Until it does,
record the selected type, outcome, boundaries, and deferred work in the PRD and
the workstream's shared context and State.
