...
describe("internal server helpers", () => {
  ...
  test("keeps the exported surface focused on read-only helpers", () => {
    ...
    expect("createDashboardTmuxObservabilitySnapshot" in serverHelpers).toBe(true)
    expect("createCurrentWorkstreamDashboardObservabilitySnapshot" in serverHelpers).toBe(true)
    expect("getResolvedDashboardTmuxObservabilitySnapshot" in serverHelpers).toBe(true)
    expect("getResolvedCurrentWorkstreamDashboardObservabilitySnapshot" in serverHelpers).toBe(true)
