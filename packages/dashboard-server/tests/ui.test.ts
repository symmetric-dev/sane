...
describe("dashboard ui route", () => {
  test("renders canonical-first dashboard scaffolding", async () => {
    ...
    expect(html).toContain("dashboard-left-pane")
    expect(html).toContain("dashboard-center-pane")
    expect(html).toContain("dashboard-right-pane")
    expect(html).toContain("ttyd-backed embed")
    expect(html).toContain("left-sidebar-overview-button")
    expect(html).toContain("left-sidebar-tree-button")
    expect(html).toContain("Status overview")
    expect(html).toContain("Work tree")
    expect(html).toContain("Terminal session picker")
    expect(html).toContain("Read-only terminal")
