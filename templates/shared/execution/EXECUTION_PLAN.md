...
before detailed Job Spec authoring. Keep implementation requirements in the approved
Design and Job Specs. Omit approval/status commentary, authorization
...
Execution defaults to sequential list order. Once Job Specs exist, do not renumber without
